...
var activity = [
  ...
  // in this custom question type, the user writes a reply and then clicks on the output textarea to see feedback:
    '<form name="quiz"><p><b>1.</b> What is the weather in Bangalore right now: clear, raining, cloudy? <input type="text" class="alphanumericOnly form-control" id="txtbox1" onBlur="check42(1, \'A search like [weather bangalore] or [bangalore weather] finds the weather forecast for today and the coming several days.\')"></p><p><font color="gray">Click here to see feedback</font><br><textarea style="width: 600px; height: 30px;" readonly="true"  name="output1"></textarea><p><b>2.</b> What time is American Flight 98 scheduled to arrive in London today? <input type="text" class="alphanumericOnly form-control" id="txtbox2" onBlur="check42(2, \'A search like [American 98] gives you up-to-date information about arrival and departure times for that flight.\')"></p><p><font color="gray">Click here to see feedback</font><br><textarea style="width: 600px; height: 30px;" readonly="true"  name="output2"></textarea></p><p><b>3.</b> What time is it now in London? <input type="text" class="alphanumericOnly form-control" id="txtbox3" onBlur="check42(3, \'A search like [time london] or [london time] tells you what time it is right now in London.\')"></p><p><font color="gray">Click here to see feedback</font><br><textarea style="width: 600px; height: 30px;" readonly="true"  name="output3"></textarea></p></form>',
